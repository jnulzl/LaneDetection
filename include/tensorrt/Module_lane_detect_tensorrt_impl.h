...
#ifndef MODULE_LANE_DETECT_TENSORRT_IMPL_H
#define MODULE_LANE_DETECT_TENSORRT_IMPL_H
...
class CModule_lane_detect_tensorrt_impl : public CModule_lane_detect_impl
{
public:
    CModule_lane_detect_tensorrt_impl();
    virtual ~CModule_lane_detect_tensorrt_impl();
...
#endif //MODULE_LANE_DETECT_TENSORRT_IMPL_H
